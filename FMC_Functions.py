...
def GET_ACCESSRULE_LIST(IP,USERNAME,PASSWORD,ACCESS_POLICY_ID):
    ...
    return json_resp
##########################################################################################################################
def GET_ACCESSRULE_DETAIL(IP,USERNAME,PASSWORD,ACCESS_POLICY_ID,RULE_ID):
    import json
    import sys
    import requests
    server = "https://"+IP
...
PASSWORD="P@ssw0rd"
#get list of acp
list1=GET_ACP_LIST(SERVER_IP,USERNAME,PASSWORD)
ACP_ID=list1[1]['id']

#get list of accessrules in acp
ACL_LIST=GET_ACCESSRULE_LIST(SERVER_IP,USERNAME,PASSWORD,ACP_ID)
...
for item in ACL_LIST['items']:
    ...
    print(json.dumps(GET_ACCESSRULE_DETAIL(SERVER_IP,USERNAME,PASSWORD,ACP_ID,RULE_ID),sort_keys=True,indent=4, separators=(',', ': ')))
    print("==================================================================================")
